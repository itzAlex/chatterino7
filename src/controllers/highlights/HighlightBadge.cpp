...
{
    return std::tie(this->badgeName_, this->showInMentions_, this->displayName_,
                    this->hasSound_, this->hasAlert_, this->soundUrl_,
                    this->color_) ==
           std::tie(other.badgeName_, other.showInMentions_, other.displayName_,
                    other.hasSound_, other.hasAlert_, other.soundUrl_,
                    other.color_);
}

HighlightBadge::HighlightBadge(const QString &badgeName, bool showInMentions,
                               const QString &displayName, bool hasAlert,
                               bool hasSound, const QString &soundUrl,
                               QColor color)
    : HighlightBadge(badgeName, showInMentions, displayName, hasAlert, hasSound,
